...
* [class.py](https://github.com/Andrej-Ilin/my_TZ/blob/main/TZ_lenta/class.py) - задание-3.2 написал код для базовой линейной алгебры: сложение, вычитание, умножение, транспонирование, нахождение определителя и построение обратной матрицы. Все это без помощи сторонней библиотеки Numpy.
